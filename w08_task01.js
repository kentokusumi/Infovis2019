function main()
{
    ...
    for ( var i = 0; i < nfaces; i++ )
    {
        ...
        var S1 = scalars[ id[1] ];
        var S2 = scalars[ id[2] ];
        var C0 = new THREE.Color().setHex( cmap[ change(S0) ][1] );
        var C1 = new THREE.Color().setHex( cmap[ change(S1) ][1] );
        var C2 = new THREE.Color().setHex( cmap[ change(S2) ][1] );
...
function change(s)
{
  var t = Math.round((s-0.1)*255/0.7);
  return t;
}
